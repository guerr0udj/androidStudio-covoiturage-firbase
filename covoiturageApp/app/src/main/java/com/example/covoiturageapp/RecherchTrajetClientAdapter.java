...
public class RecherchTrajetClientAdapter extends RecyclerView.Adapter<RecherchTrajetClientAdapter.CustomViewHolder>{

    private final RecyclerViewInterface recyclerViewInterface;
    Context context;
    ArrayList<Trajet> listTrajetInfo;

    public RecherchTrajetClientAdapter(Context context, ArrayList<Trajet> listTrajetInfo,RecyclerViewInterface recyclerViewInterface) {
    ...
    @NonNull
    @Override
    public RecherchTrajetClientAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecherchTrajetClientAdapter.CustomViewHolder(itemView, recyclerViewInterface);
    }

    @Override
    public void onBindViewHolder(@NonNull RecherchTrajetClientAdapter.CustomViewHolder holder, int position) {
        ...
        */
        ...
        holder.userName.setText(listTrajetInfo.get(position).getNom());
        holder.heureDepart.setText(listTrajetInfo.get(position).getHeursDepart());
        holder.pointDepart.setText(listTrajetInfo.get(position).getVilleDepart());
        holder.pointArrivee.setText(listTrajetInfo.get(position).getVilleArrivee());
